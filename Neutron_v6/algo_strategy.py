...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if game_state.turn_number == self.switch_turn:
            if self.left_dem_crossing > self.right_dem_crossing:
                ...
                self.buff_walls += [[2, 13], [5, 13]]
                self.upgrade_buff += [[2, 13], [5, 13]]
                ...
                self.buff_walls += [[25, 13], [22, 13]]
                self.upgrade_buff += [[25, 13], [22, 13]]
    ...
    def starter_strategy(self, game_state):
        ...
        elif (self.non_attack_turns > 3 and game_state._player_resources[0]['MP']>8):
